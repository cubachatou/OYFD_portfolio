...
export default function CurveSVG() {
  ...
  return (
    <>
      <div style={{opacity: dimensions.width == null ? 1 : 0}} className="w-screen h-[calc(100vh+600px)] top-0 left-0 fixed z-50 pointer-events-none bg-black transition-opacity duration-0 delay-[0.1s]"></div>
