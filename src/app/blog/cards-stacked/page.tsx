      ...
      <div ref={container} className="container">
        <ul className="flex flex-col items-center">
          {images.map((image, index) => (
            <li key={index} className="sticky top-[15vh] h-[70vh] flex items-center justify-center mb-[15vh] will-change-[transform,_scale,_filter]">
              <Image src={image} alt='' width={400} height={600} className="w-full h-full rounded-lg" />
            </li>
          ))}
        </ul>
      </div>
