...
export default function BlogPage() {
  ...
  return (
    <div>
      <Header currentPage="blog" classes="sticky top-0 left-0 right-0 border-b border-neutral-200 bg-neutral-100" />

      <main className="py-24">
        <div className="container flex gap-16 items-start">
          <aside className="shrink-0 basis-[240px] hidden"></aside>

          <section className="grow flex flex-col gap-16">
            <div className="flex flex-col gap-8">
              <h1 className="max-w-[1008px] text-[50px]/tight font-medium [&_span]:font-bold [&_span]:text-[72px]/none [&_span]:font-dancing"><span>Step into</span> my blog world! I'm <span>Oleksii</span>, and here I capture my latest <span>escapades</span>.</h1>
