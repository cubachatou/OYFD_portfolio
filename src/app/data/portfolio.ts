...
export const portfolioData: portfolioData[] = [
  {
    ...
    year: "2021-2024",
    description:
      "At Mavericks Agency, I helped develop Kyiv Educational Hub, a platform offering online courses to build professional ratings. With a gamified interface and simple design, the platform now supports over 3.7 million users in Kyiv, helping HR professionals find qualified employees.",
  ...
  },
  {
    ...
    year: "2021-2024",
    description:
      "I developed a promotional service for OLX.kz’s August 2021 campaign, where users earned chances to win prizes by placing ads. Integrated with the OLX API, the system ran smoothly throughout the promotion, meeting the client’s needs.",
  ...
  },
  {
    ...
    year: "2021-2024",
    description:
      "I contributed to the development of a multi-page landing site for OLX B2B, consolidating all user segments. The project included a service cost calculator, multilingual support, and dynamic animations, ensuring a secure and user-friendly platform for OLX’s business clients.",
  ...
  },
  {
    ...
    year: "2021-2024",
    description:
      "I helped develop Zelena’s ecommerce platform with a premium, minimalist design, integrating it with their sales system. The project reinforced Zelena’s position as a leader in luxury gifts and exclusive bouquets in Ukraine.",
  ...
  },
  {
    ...
    year: "2021-2024",
    description:
      "I contributed to ThePrintSpace website using WordPress, integrating Google Sheets API for price list management and Intercom API for CRM lead tracking. The site, launched in 2019, became a primary lead-generation tool for the client.",
